...
* __run_analysis.R__: R script to transform raw data set in a tidy data set
...
In the parent directory you will find the file `sensorAvgByActSub.txt` with the tidy data set.